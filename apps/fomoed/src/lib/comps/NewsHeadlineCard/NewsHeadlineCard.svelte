...
<a href={article?.detailUrl} class="block duration-500 ease-in-out" class:skeletoned={skeleton}>
	...
	>
		<!-- Headline -->
		<h2
			class="text-[24px] md:text-[28px] font-semibold tracking-[-0.02em] text-white leading-snug mb-[14px] relative px-5 md:px-8"
		...
		<!-- Summary -->
		<p
			class="text-[#919191] mb-0 relative text-[18px] leading-[135%] font-semibold tracking-[-0.02em] px-5 md:px-8 line-clamp-4"
			class:whitespace-pre={skeleton}
		>
			<TextSkeleton absolute {skeleton} wrap={false} />
