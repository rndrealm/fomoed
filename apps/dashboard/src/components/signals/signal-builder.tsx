...
const SignalBuilder: React.FC<SignalBuilderProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-center mb-4">
        ...
        >
          <ToggleGroupItem
            ...
            className="px-6 py-2 data-[state=on]:bg-signal-purple data-[state=on]:text-white"
          >
      ...
      {buildMode === "ai" ? (
        <>
          <div className="border-2 border-amber-400">TODO: </div>
          {/* <AISignalBuilder signal={signal} onUpdateSignal={handleUpdateSignal} /> */}
        </>
      ) : (
        <ManualSignalBuilder
