        ...
        <div className="relative w-fit mx-auto flex flex-col items-center justify-center">
          <div className="relative pointer-events-none">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <h1 className="font-inter font-[500] leading-[1.35] text-[200px] text-[#212121]">
                {content.error}
              </h1>
            </div>
          </div>

          <div className="relative w-[30%] mx-auto flex flex-col items-center gap-5 mt-4">
            <div className="absolute z-[-10] pointer-events-none bottom-0 translate-y-[120px] left-1/2 -translate-x-1/2 ">
              <ElipseBackground />
            </div>
            <div className="flex flex-col items-center gap-1.5">
              <h2 className="leading-[24px] font-[500] text-base text-white">
                {content.message}
              </h2>
            ...
            <button
              className="bg-[#FF3B10] rounded-[6px] border-[1px] border-[#464646]
            text-white text-[0.75rem] leading-[18px] py-[7px] px-5 cursor-pointer
              text-center
          "
            >
              {content.label}
