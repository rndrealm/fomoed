            ...
            <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-2 px-5">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="font-regular text-[#A4A4A4] leading-[1.35] text-xs">{authUser?.email}</p>
                    </div>
                </div>

                <div className="flex flex-col">
                    <div className="py-2 border-y border-[#333333] flex justify-between items-center px-5">
                        <p className="font-medium text-white leading-[1.35] text-[13px]">Fomoed {data?.planType}</p>
                    ...
                    <div className="py-2 border-b border-[#333333] flex justify-between items-center px-5">
                        <p className="font-medium text-white leading-[1.35] text-[13px]">BETA Version</p>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <div
                                    className={cn("w-[16px] h-[16px] rounded-sm", isBeta ? "bg-white" : "bg-[#373737]")}
                                ></div>
                                <p
                                    className={cn(
                    ...
                    <div className="pt-2 px-5">
                        <button type="button" className="py-2 w-full" onClick={handleLogout}>
                            <div className="flex gap-2">
                                <Logout />

                                <p className="font-medium text-white leading-[1.35] text-[13px]">Logout</p>
                            </div>
                        </button>
                    </div>
                </div>
