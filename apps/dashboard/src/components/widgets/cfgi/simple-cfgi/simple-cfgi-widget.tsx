...
import { FullscreenableSimpleCfgiChart } from "./fullscreenable-simple-cfgi-chart";
import { SimpleCfgiFullscreenControls } from "./simple-cfgi-fullscreen-controls";
          ...
          <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
            ...
            <div className="flex flex-wrap items-center justify-start gap-2 sm:justify-end">
              ...
              <CameraAndRefresh
                ...
                chartRef={chartRef}
                file="Simple Fear and Greed Chart.png"
                refetch={refetch}
              />
            </div>
          </div>
