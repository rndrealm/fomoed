...
import { FullscreenableExchangeLiquidationChart } from "./fullscreenable-exchange-liquidation-chart";
import { ExchangeLiquidationMapFullscreenControls } from "./exchange-liquidation-map-fullscreen-controls";
...
export default function LiquidationExchangeWidget(props: IProps) {
  ...
  return (
    <WidgetWrapper widget={widget} title="Exchange Liquidation Map" handleLearnMore={() => setShowInfo(true)}>
        ...
        <div className={cn("relative flex flex-col", isFullscreen ? "h-full" : "flex-1")} ref={chartRef}>
          ...
          <PremiumOverlay>
            <div className="mx-3 flex-1 min-h-[250px]">
              <FullscreenableExchangeLiquidationChart
              ...
              <div className="flex flex-col gap-4 justify-between flex-1 h-full">
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col">
                    <h3 className="text-base leading-[1.35] font-semibold text-white">Exchange Liquidation Map</h3>
      ...
      <ExchangeLiquidationMapFullscreenControls
        isFullscreen={isFullscreen}
        ...
        setPeriodValue={handlePeriodChange}
      />
    </WidgetWrapper>
  );
}