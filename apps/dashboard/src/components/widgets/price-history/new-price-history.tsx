      ...
      <div className="relative flex h-full flex-col gap-0 rounded-2xl bg-[#000] pt-0 pb-2 min-h-0 no-scrollbar">
        <div className="flex flex-col gap-1 min-h-0 flex-shrink-0">
          ...
          <div className="mb-1 flex items-center justify-between flex-wrap px-4">
            ...
            <div className={`flex items-center gap-2 mt-2 sm:mt-0  ${containerWidth < 600 ? 'w-full pt-3 justify-between' : 'w-auto justify-end'}`}>
              ...
              <div className={`flex items-center gap-2 w-full sm:w-auto ${containerWidth < 600 ? 'justify-end' : 'justify-end'}`}>
                <button
                  onClick={() => {
        ...
        <div
          className="absolute left-[9px] bottom-[60px] z-[9] h-[28px] py-1 pl-1 pr-2.5 rounded-full border border-[#393939] bg-[#2B2C2E]"
        >
          <button
