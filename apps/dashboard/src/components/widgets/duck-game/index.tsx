...
import { PreviousRace, RaceFinished, RaceUpdate } from "./types";
...
export default function Index(props: IProps) {
  ...
  useSocketEvent("races", (data: PreviousRace) => {
  ...
  useSocketEvent("race_state_update", (data: RaceUpdate) => {
  ...
  useSocketEvent("race_finished", (data: RaceFinished) => {
    ...
    <div className="relative flex h-full flex-col gap-0 rounded-2xl bg-white pt-0 pb-0 overflow-hidden">
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="font-semibold text-sm leading-[1.35] tracking-[-0.4%] text-[#0A0A0A]">
                  Race #
                  {raceUpdate?.race_id || previousRace?.previous_races?.race_id}
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-4 px-4 pb-4 flex-1 overflow-y-auto scrollbar">
        ...
        <div className="p-[2px] bg-[#E3E3E3] rounded-lg flex flex-col">
          <div className="bg-[#F8F8F8] rounded-md p-3 flex items-center gap-4">
          ...
          <div className="flex py-[10px] px-3">
            <div className="h-[8px] w-[30%] rounded-4xl bg-[linear-gradient(270deg,#febd0e_0%,#81ab9a_49.36%,#00af58_100%)]"></div>
          </div>
        </div>
        ...
        <div className="flex flex-col pb-4">
          <table className="w-full table-auto relative">
            ...
            <tbody>
              {(raceUpdate?.ducks || previousRace?.previous_races?.ducks)?.map(
                (item, index) => {
