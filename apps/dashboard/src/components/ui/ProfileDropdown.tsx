...
import { authUserAtom, publicUserDataAtom, isLoadingUserAtom, resetAuthState } from "@/lib/atoms/userAtom";
        ...
        return (
            <div className="w-[200px] bg-[#0F0D0DE5] border-[#FFFFFF1A] rounded-[10px] p-5 flex flex-col items-center top-0 border backdrop-blur-lg z-40">
                <div className="text-white text-center mb-4">
                    ...
                    <p className="text-[#FFFFFF99] text-xs mt-1">Sign in to access all features</p>
                </div>
