...
import { updateSettingsAction, updateSettingsActiveTab } from "@/services/queries/settings/actions";
...
export const loadSettingsFromApiAtom = atom(null, (_, set, newSetting: IDashboardData["settings"]) => {
...
export const updateSettingAtom = atom(null, async (_, set, newSetting: IDashboardData["settings"]) => {
