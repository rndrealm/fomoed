...
export async function getEligibleCommissionsForPayout() {
  ...
  try {
    ...
    // Check each referrer's subscription status via Stripe
    ...
    // Filter to only eligible referrers
    ...
    // Get Stripe account info for eligible referrers
