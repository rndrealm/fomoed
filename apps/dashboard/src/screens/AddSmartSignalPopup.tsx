...
function hasPlaceholderOperand(obj: any): boolean {
  ...
  if (typeof obj === "object" && obj !== null) {
    ...
    if ("and" in obj && Array.isArray(obj.and) && obj.and.length === 0)
      return true;
    if ("or" in obj && Array.isArray(obj.or) && obj.or.length === 0)
      return true;
...
export function AddSmartSignalPopup({ trigger }: AddSmartSignalPopupProps) {
  ...
  const isCreateDisabled =
    Object.keys(condition).length < 1 || hasPlaceholderOperand(condition);
