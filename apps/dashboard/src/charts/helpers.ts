 ...
 */
export function evaluate_cmap(x: number, name: "viridis", reverse?: boolean) {
  ...
  const colors = colorMapData[name]["colors"];
  const interpolate = colorMapData[name]["interpolate"];
