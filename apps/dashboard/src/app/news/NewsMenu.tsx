    ...
    return (
        <div className="relative flex flex-col items-start justify-between gap-3 pb-4">
            ...
            <div className="flex w-full flex-row items-center gap-0 lg:gap-4.5">
                ...
                {/* Search Icon */}
                <button>
                    <div onClick={() => setIsSearching(true)} className="absolute top-[10px] right-20 scale-105 lg:scale-100 lg:static flex flex-row items-center justify-center p-2 rounded-[8px] bg-[#0C0C0C] border-[1px] border-[#2A2A2A]">
