...
const LoadingSpinner: React.FC = () => (
  <div className="w-10 h-10 border-2 rounded-full border-opacity-80 animate-spin border-white/10 border-t-transparent" />
);
  ...
  return (
    <div className="h-full min-h-[calc(100svh-86px)] w-full bg-black pb-4">
      ...
      <div className="relative w-full">
        ...
        {/* {isFetchingNextPage &&
                    <div className="fixed inset-0 z-50 flex items-center w-full h-screen bg-black">
                        <LoadingSpinner />
                    </div>
                } */}
        ...
        <div
          ...
          className="absolute bottom-0 left-0 w-full h-10 bg-transparent"
        ></div>
      </div>
    </div>
  );
