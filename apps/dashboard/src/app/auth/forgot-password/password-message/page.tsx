      ...
      <div className="relative flex h-full w-full max-w-[372px] flex-col items-center justify-center">
        ...
        <div>
          ...
          <h3 className="text-center text-base leading-[150%] font-medium text-[#5C5C5C]">
            We&apos;ve sent you an email Check your inbox. Check your inbox and follow the instructions to reset your
            account.
          </h3>
        </div>
        <div className="pt-16">
          <p className="text-center text-base font-semibold text-[#5C5C5C]">
            Wrong email address?{" "}
            <Link className="text-white" href={AppRoutes.auth.forgotPassword.path}>
              Change Email.
            </Link>
          </p>
        </div>
