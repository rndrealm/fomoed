        ...
        <div className="fixed inset-0 h-[100svh] w-full overflow-hidden">
            <div className="w-full h-full flex items-center justify-center overflow-hidden bg-[#000]">
                <div className="w-full h-full flex items-center justify-center scale-105">
                    ...
                    <div className="pointer-events-none relative w-full h-full pb-[200px] flex items-center justify-center gap-[160px]">


                        <motion.div
                            style={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ duration: 1, delay: 1, ease: "easeInOut" }} className="pl-4.5">
                            <p
                                style={{
                                    background: `
            linear-gradient(180deg, #555555 -29.73%, rgba(17, 17, 17, 0.5) 59.31%),
            linear-gradient(148.65deg, rgba(0, 0, 0, 0) 62.33%, rgba(192, 86, 30, 0.49) 87.85%)`,
                                    ...
                                    fontFamily: 'Inter',
                                    fontWeight: '500',
                                    WebkitTextFillColor: 'transparent', // necessary for full clipping in some browsers
